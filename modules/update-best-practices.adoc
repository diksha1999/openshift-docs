...
[IMPORTANT]
====
It is not possible to update a cluster to {product-title} 4.17 or 4.18 if it is using the OpenShift SDN network plugin. You must migrate to the OVN-Kubernetes plugin before upgrading to {product-title} 4.17 or 4.18. 
====
